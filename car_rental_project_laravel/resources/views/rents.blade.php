...
<body>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <span class="custom-checkbox">
                                            <input type="checkbox" id="checkbox{{ $rent->idRent }}" name="options[]" value="{{ $rent->idRent }}">
                                            <label for="checkbox{{ $rent->idRent }}"></label>
                                        </span>
                                    </td>
                                    <td>{{ $rent->car }}</td>
                                    <td>{{ $rent->name }}</td>
                                    ...
                                    <td>
                                        <a href="#editCarModel" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                        <a href="#deleteCarModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
	...
	<!-- Edit Modal HTML -->
	<div id="editCarModel" class="modal fade">
